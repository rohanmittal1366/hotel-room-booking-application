...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee(){
        ...
        name.setFont(new Font("Takoma", Font.PLAIN, 17));
        ...
        age.setFont(new Font("Takoma", Font.PLAIN, 17));
        ...
        gender.setFont(new Font("Takoma", Font.PLAIN, 17));
        ...
        job.setFont(new Font("Takoma", Font.PLAIN, 17));
        job.setBounds(60, 180, 120, 30);
        add(job);
        
        String str[] = {"Manager", "Receptionist", "Accountant", "Head Clerk", "Junior Clerk", "Bell Boy", "Chef", "Janitor", "Room Service", "Kitchen Staff", "Waiter/Waitress"};
        ...
        salary.setFont(new Font("Takoma", Font.PLAIN, 17));
        ...
        phone.setFont(new Font("Takoma", Font.PLAIN, 17));
        ...
        aadhar.setFont(new Font("Takoma", Font.PLAIN, 17));
        ...
        email.setFont(new Font("Takoma", Font.PLAIN, 17));
        ...
        JLabel l2 = new JLabel("ADD EMPLOYEES DETAILS");
